...
describe("JessicaRoyce_Properties_Test_1", function(){
	it("Verify_Sorting_Properties_By_Most_Expensive_To_Least", async function(){
		let driver;
		try{
			...
			await driver.findElement(By.xpath("//option[. = 'Price Descending']")).click();
			...
			let orderCheck = "Pass!"; 
			/*Going through price list to check if they are in descending order */
